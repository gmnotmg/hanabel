...
export function AffiliateDisclosure({ text }: { text: string }) {
  ...
  return (
    <aside className="flex items-center gap-3 rounded-[24px] border border-lilac-100 bg-white/80 px-4 py-3 text-xs leading-5 text-slate-500 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
